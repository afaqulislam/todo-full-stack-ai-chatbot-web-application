      ...
      <section className="py-16 sm:py-24 px-4">
        <div className="max-w-7xl mx-auto text-center">
          <div className="inline-flex items-center bg-gradient-to-r from-blue-50 to-indigo-50 px-4 py-2 rounded-full text-sm font-medium mb-6 border border-blue-100">
            <span className="text-blue-600">✨ AI-Powered Productivity</span>
          </div>
          ...
          <p className="text-lg sm:text-xl hero-subheading mb-8 max-w-2xl mx-auto leading-relaxed">
            Taskory is an AI-powered task management platform that helps you stay organized, focused, and productive. Use natural language commands to manage your tasks effortlessly. Built for professionals who demand excellence.
          </p>
          ...
          <div className="relative max-w-4xl mx-auto">
            <div className="rounded-2xl bg-white border border-gray-200 p-2 shadow-lg">
              ...
              <div className="aspect-image rounded-xl overflow-hidden bg-gray-100">
                <Image
                  src="/taskory-dashboard-preview.png"
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <h3 className={"text-xl font-semibold mb-2 text-gray-900"}>AI-Powered Task Management</h3>
              <p className={"text-gray-600"}>
                Use natural language commands to create, update, and manage tasks. Our AI assistant understands context and intent to streamline your workflow.
              </p>
            </div>
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <h3 className={"text-xl font-semibold mb-2 text-gray-900"}>Natural Language Processing</h3>
              <p className={"text-gray-600"}>
                Communicate with your task manager using everyday language. Tell Taskory what you need done, and watch it handle the rest automatically.
              </p>
            </div>
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <h3 className={"text-xl font-semibold mb-2 text-gray-900"}>Intelligent Task Prioritization</h3>
              <p className={"text-gray-600"}>
                Smart algorithms automatically prioritize your tasks based on deadlines, importance, and dependencies to keep you focused on what matters most.
              </p>
            </div>
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <h3 className={"text-xl font-semibold mb-2 text-gray-900"}>Status Management</h3>
              <p className={"text-gray-600"}>
                Effortlessly manage your tasks with intuitive status options: Backlog, Todo, In Progress, Review, and Done, for complete workflow control.
              </p>
            </div>
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <h3 className={"text-xl font-semibold mb-2 text-gray-900"}>Smart Due Dates</h3>
              <p className={"text-gray-600"}>
                Set intelligent deadlines with smart reminders that adapt to your schedule and help you meet your goals efficiently.
              </p>
            </div>
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <h3 className={"text-xl font-semibold mb-2 text-gray-900"}>Lightning Fast AI</h3>
              <p className={"text-gray-600"}>
                Experience near-instant responses from our AI assistant with optimized algorithms and fast processing times.
              </p>
            </div>
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              <div className="w-12 h-12 bg-gradient-to-r from-teal-500 to-cyan-600 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className={"group p-6 rounded-2xl bg-white border border-gray-200 hover:border-blue-500/50 border transition-all duration-300 hover:shadow-md hover:-translate-y-1"}>
              ...
              <p className={"text-gray-600"}>
                Share tasks, assign responsibilities, and collaborate with your team in real-time with our AI-powered assistant.
              </p>
            </div>
          </div>
        </div>
      ...
      <section id="how-it-works" className={"py-20 px-4 bg-white"}>
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className={"text-lg text-gray-600 max-w-2xl mx-auto"}>
              Simple setup process to start using natural language commands for your tasks
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">Sign Up & AI Setup</h3>
                  <p className="text-gray-600">
                    Create your account and let our AI assistant learn your workflow preferences to personalize your experience.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">Add Tasks via AI</h3>
                  <p className="text-gray-600">
                    Use natural language commands to add tasks. Just type "Add a task to buy groceries with high priority" and let our AI handle the rest.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2 text-gray-900">AI-Powered Management</h3>
                  <p className="text-gray-600">
                    Let our AI assistant manage priorities, suggest optimal schedules, and keep you productive with intelligent notifications.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="rounded-2xl bg-gray-50 border border-gray-200 p-6 shadow-sm">
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-lg font-semibold text-gray-900">AI Task Overview</h3>
      ...
      <section id="benefits" className="py-20 px-4 bg-gray-50/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Join thousands of professionals who have transformed their productivity with AI
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-gray-900">AI-Powered Efficiency</h3>
                <p className="text-gray-600">
                  Our intelligent assistant understands natural language commands and automates task management for maximum productivity.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                <h3 className="text-xl font-semibold mb-2 text-gray-900">Intuitive AI Design</h3>
                <p className="text-gray-600">
                  Thoughtfully crafted interface that seamlessly integrates AI features to keep you focused on your work.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-start space-x-4">
              ...
              <div>
                ...
                <p className="text-gray-600">
                  Access your tasks from any device with seamless synchronization across platforms, including our AI assistant.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 px-4 bg-gradient-to-r from-blue-600 to-indigo-700">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl !text-white/90 mb-8 max-w-2xl mx-auto">
            Join thousands of professionals who have streamlined their workflow with our AI assistant
          </p>
