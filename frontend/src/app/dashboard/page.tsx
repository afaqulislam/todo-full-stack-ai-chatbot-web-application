...
import { Button, Card, CardContent, CardHeader, CardTitle, Input, Textarea, Select, Badge } from '@/src/components/ui';
...
export default function DashboardPage() {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 to-gray-100 transition-colors duration-200">
      ...
      {/* Chat Interface */}
      <ChatInterface onTaskUpdated={fetchTodos} showNotification={showNotification} />
    </div>
  );
}